...
export const JOBS_MERU = [
  {
    name: 'Meru Auto-Parts E-Commerce - Frontend Engineer',
    id: 2,
    stack: 'React.js, TypeScript, Tailwind CSS, React Query, React hooks, CSS',
    description:
      'As a Frontend Engineer at Meru, I played a crucial role in elevating the online shopping experience for customers. My responsibilities span across various aspects of the e-commerce platform, ensuring functionality, convenience, and seamless operations.',
    description_up:
      'This role at Meru allowed me to leverage cutting-edge technologies to enhance the e-commerce experience, from the frontend development of key features to the optimization of operational processes. The position demanded a holistic approach, combining technical expertise with a keen understanding of business requirements.',
    activities_name: 'Key Challenges and Achievements:',
    activities: [
      {
        id: 21,
      ...
      },
      {
        ...
        description:
          'Implemented Twilio messages to enhance customer communication. Customers were notified of their order status through automated messages, fostering transparency and providing timely support.',
      },
      {
        id: 24,
...
export const JOBS_ASSISTENSI = [
  {
    ...
    description_up:
      'This role not only demanded technical prowess but also required a keen understanding of the healthcare domain to ensure the operative system met the unique needs of medical professionals. Through strategic design and development, the project aimed to contribute to the overall efficiency and effectiveness of medical care delivery.',
    activities_name: 'Key Challenges and Achievements:',
    activities: [
      {
        id: 31,
